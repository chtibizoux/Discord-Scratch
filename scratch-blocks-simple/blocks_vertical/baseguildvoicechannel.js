...
goog.provide('Blockly.Blocks.baseguildvoicechannel');

goog.require('Blockly.Blocks');
goog.require('Blockly.Colours');
goog.require('Blockly.constants');
goog.require('Blockly.ScratchBlocks.VerticalExtensions');
Blockly.Blocks['baseguildvoicechannel_rtcRegion'] = {
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.baseguildvoicechannel,
      "extensions": ["colours_baseguildvoicechannel", "output_string"]
    });
  }
};
...
Blockly.Blocks['baseguildvoicechannel_setRTCRegion'] = {
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.baseguildvoicechannel,
      "extensions": ["colours_baseguildvoicechannel", "shape_statement"]
    });
  }
};
