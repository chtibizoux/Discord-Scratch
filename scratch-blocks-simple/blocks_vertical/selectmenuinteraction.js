...
goog.provide('Blockly.Blocks.selectmenuinteraction');

goog.require('Blockly.Blocks');
goog.require('Blockly.Colours');
goog.require('Blockly.constants');
goog.require('Blockly.ScratchBlocks.VerticalExtensions');
Blockly.Blocks['selectmenuinteraction_values'] = {
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.selectmenuinteraction,
      "extensions": ["colours_selectmenuinteraction", "output_string"]
    });
  }
};
...
Blockly.Blocks['selectmenuinteraction_deferReply'] = {
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.selectmenuinteraction,
      "extensions": ["colours_selectmenuinteraction", "shape_statement"]
    });
  }
};
