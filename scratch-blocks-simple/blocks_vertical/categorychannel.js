...
goog.provide('Blockly.Blocks.categorychannel');

goog.require('Blockly.Blocks');
goog.require('Blockly.Colours');
goog.require('Blockly.constants');
goog.require('Blockly.ScratchBlocks.VerticalExtensions');
Blockly.Blocks['categorychannel_children'] = {
  init: function() {
    this.jsonInit({
      "message0": "children of %1",
      "args0": [
        {
          "type": "input_value",
      ...
      "category": Blockly.Categories.categorychannel,
      "extensions": ["colours_categorychannel", "output_string"]
    });
  }
};
...
Blockly.Blocks['categorychannel_setParent'] = {
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.categorychannel,
      "extensions": ["colours_categorychannel", "shape_statement"]
    });
  }
};
